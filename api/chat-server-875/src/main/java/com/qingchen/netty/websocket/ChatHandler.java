...
import com.qingchen.enums.MsgTypeEnum;
import com.qingchen.grace.result.GraceJSONResult;
import com.qingchen.pojo.netty.ChatMsg;
import com.qingchen.pojo.netty.DataContent;
...
//SimpleChannelInboundHandler:对于请求来说,相当于入站
    //TextWebSocketFrame:用于为websocket,数据以frames进行传输的,Frame是数据(消息)的载体
